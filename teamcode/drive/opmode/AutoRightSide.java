...
public class AutoRightSide extends LinearOpMode {
    ...
    protected void runSample() throws InterruptedException {
        ...
        Trajectory traj2 = drive.trajectoryBuilder(new Pose2d(-32, 48, Math.toRadians(-90)))
                .splineToConstantHeading(new Vector2d(-32, 4), Math.toRadians(-90))
                .build();

        //COme back
        Trajectory traj3 = drive.trajectoryBuilder(new Pose2d(-32, 4, Math.toRadians(-90)))
        ...
        //creep backwards
        Trajectory traj6 = drive.trajectoryBuilder(new Pose2d(-24, 8, Math.toRadians(-90)))
                .splineToConstantHeading(new Vector2d(-24, 12), Math.toRadians(-90))
                .build();
